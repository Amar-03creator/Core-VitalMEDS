export const HsnGstFields = ({ formData, setFormData, errors, setErrors, toast, engageTrap, releaseTrap, isLocked }) => (
  <div className="grid grid-cols-2 gap-3">
    <div>
      ...
      <input
        ...
        className={`w-full border border-slate-300 rounded-xl px-3 py-2.5 text-base outline-none focus:border-emerald-400 ${isLocked ? 'bg-slate-100 text-slate-500 cursor-not-allowed' : 'bg-white'}`}
      />
    </div>
    <div>
