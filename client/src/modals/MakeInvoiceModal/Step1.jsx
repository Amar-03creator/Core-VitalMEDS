...
export const Step1 = ({
  ...
  useGridNavigation(step1Ref, '.nav-input');
  ...
  return (
    <div className="flex flex-col h-full pb-1" ref={step1Ref}>
        ...
        {lockClient && selectedClient ? (
          ...
          <div className="relative">
            ...
            <input
              ...
              className="nav-input w-full bg-slate-50 border border-slate-300 rounded-xl px-3 py-2 text-lg font-bold text-slate-900 outline-none focus:border-emerald-500 shadow-sm"
            />
