...
export const Step3 = ({
  ...
  useGridNavigation(step3Ref, '.nav-input');
  ...
  return (
    <div className="flex flex-col h-full" ref={step3Ref}>
      <div className="flex-1 overflow-y-auto space-y-4">
          ...
          <div className="flex justify-between items-center px-4 py-2 text-base bg-amber-50">
            ...
            <div className="flex items-center gap-3">
              <input 
                ...
                className="nav-input w-20 border border-amber-200 rounded-md px-2 py-0.5 text-right font-bold text-amber-900 focus:outline-none focus:border-amber-400 shadow-inner" 
              />
              {finalDiscount > 0 && (
        ...
        <div className="bg-white border border-slate-200 rounded-xl p-3 shadow-sm">
          ...
          <textarea
            ...
            className="nav-input w-full bg-slate-50 border border-slate-200 rounded-lg px-3 py-2 text-sm font-medium text-slate-700 outline-none focus:border-slate-400 focus:bg-white transition-colors min-h-[70px] resize-none"
          />
        </div>
