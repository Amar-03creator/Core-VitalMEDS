...
//   // Local string states for smooth typing
...
//     onUpdateItem(index, 'chargeableQty', val);
//   };
//   const commitFree = () => {
//     let val = parseFloat(freeText);
//     if (isNaN(val) || val < 0) val = 0;
//     setFreeText(String(val));
//     onUpdateItem(index, 'freeQty', val);
//   };
//   const commitDisc = () => {
//     let val = parseFloat(discText);
//     if (isNaN(val) || val < 0) val = 0;
//     setDiscText(String(val));
//     onUpdateItem(index, 'discountValue', val);
//   };

//   // ✨ FIX: Apply the locked-down Offer theme
...
//               {/* ✨ Pill removed because the entire card theme signals Offer now */}
//             </div>
...
//               disabled={item.isOfferBatch} // ✨ Strictly Lock Offer Batch
...
//               {/* ✨ Strictly remove PTR edit for Offers */}
//               {!item.isOfferBatch && (
...
//               className="w-full min-w-0 text-center bg-slate-100 border border-slate-200 rounded-lg px-1 sm:px-2 py-1.5 text-base sm:text-xl font-black text-slate-400 shadow-inner cursor-not-allowed"
//             />
//           </div>
//           <div className="flex-[1] min-w-0">
...
//               onBlur={commitQty}
//               className={`w-full min-w-0 text-center border rounded-lg px-1 sm:px-2 py-1 text-lg sm:text-xl font-black focus:outline-none focus:bg-white shadow-inner transition-colors ${item.clientEdited ? 'bg-amber-50 border-amber-400 text-amber-900 focus:border-amber-600' : 'bg-slate-50 border-slate-300 text-slate-900 focus:border-slate-600'}`}
//             />
//           </div>
//           <div className="flex-[1] min-w-0">
...
//               onBlur={commitFree}
//               className="w-full min-w-0 text-center bg-emerald-50 border border-emerald-300 rounded-lg px-1 sm:px-2 py-1 text-lg sm:text-xl font-black text-emerald-900 focus:outline-none focus:border-emerald-600 focus:bg-white shadow-inner"
//             />
//           </div>
...
//                 className={`flex-1 min-w-0 w-full h-full text-center border rounded-l-lg border-r-0 px-0.5 sm:px-1 text-lg sm:text-xl font-black shadow-inner ${item.isOfferBatch ? 'bg-orange-50 border-orange-200 text-orange-900 cursor-not-allowed' : 'bg-amber-50 border-amber-300 text-amber-900 focus:outline-none focus:border-amber-500 focus:bg-white'}`}
//               />
//               <button
...
//         {/* ✨ Locked Offer Banner with Overlapping Floating Pill */}
//         {item.isOfferBatch ? (
...
//             {/* Overlapping Floating Pill fixed with -top-3 */}
