...
//                 let expiryText = 'N/A';
//                 const rawDate = item.offerBatchId?.expiryDate || item.offerBatchId?.expiry || item.closestExpiry;
//                 if (rawDate) {
...
//                 // ✨ FIX: Bulletproof Frontend Math Fallback!
...
//                 return (
//                   <div key={i} className="border border-slate-200 rounded-xl bg-white shadow-sm flex flex-col overflow-hidden">
                    
//                     <div className="bg-slate-50 border-b border-slate-200 px-3 md:px-4 py-2.5">
//                       <p className="font-black text-slate-900 text-lg md:text-xl leading-tight truncate">
//                         <span className="inline-block bg-slate-800 text-white text-xs md:text-sm font-black px-2 py-0.5 rounded-l-sm rounded-r-xl shadow-sm mr-2 align-text-bottom">
//                           #{i + 1}
//                         </span>
...
//                       <div className="flex flex-wrap gap-x-3 md:gap-x-5 gap-y-2 text-sm md:text-base font-medium">
...
//                       <div className="flex flex-wrap items-center gap-x-3 md:gap-x-5 gap-y-2 text-sm md:text-base font-medium mt-1.5">
//                         {hasQuoteData && item.adminOfferedPTR != null ? (
...
//                           <span className="text-emerald-800 bg-emerald-100 px-2 py-0.5 rounded font-black text-sm md:text-base shadow-sm ml-auto">
...
//                   Bill Discount Applied ({inquiry.discountType === 'percent' ? `${inquiry.discountPercent}%` : `₹${inquiry.discountValue}`})
//                 </p>
...
//                 <div>
//                   <p className="text-sm md:text-base text-blue-700 font-black mb-0.5 uppercase tracking-wide">{inquiry.status === 'Accepted' ? 'Your Acceptance Note' : 'Your Initial Note'}</p>
//                   <p className="text-blue-900 text-sm md:text-base font-medium leading-snug">{inquiry.clientNote || inquiry.clientRemarks}</p>
//                 </div>
//               </div>
//             )}
...
//                 <div>
//                   <p className="text-sm md:text-base text-slate-700 font-black mb-0.5 uppercase tracking-wide">Note from Admin</p>
