  ...
  <div className="bg-white rounded-2xl border border-red-100 overflow-hidden">
    <div className="px-4 py-3.5 border-b border-red-100 flex items-center justify-between">
      <h2 className="text-slate-800 font-semibold text-xl flex items-center gap-2">
        ...
        <span className="text-sm font-bold bg-red-100 text-red-600 px-2 py-0.5 rounded-full">Watchlist</span>
      </h2>
    </div>
          ...
          <div key={name} className="px-4 py-3.5 flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              <div className="flex items-center gap-2.5 mt-1">
                ...
                <span className="text-sm font-medium text-slate-500">Score: <span className="text-red-500 font-bold">{score}/100</span></span>
              </div>
            </div>
            <div className="text-right shrink-0">
              {/* ✨ FIX: Increased Outstanding and Days text size */}
              <p className="text-red-600 text-base font-bold">{outstanding}</p>
              <p className="text-slate-500 text-sm font-medium mt-0.5">{days}d overdue</p>
            </div>
          </div>
        ))}
      </div>
    ...
    <div className="px-4 py-3 border-t border-slate-100">
      <Link 
        ...
        className="text-red-500 text-base font-semibold flex items-center gap-1"
      >
