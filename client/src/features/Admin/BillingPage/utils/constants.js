...
export const CLIENT_MASTER = {
  'Apollo Pharmacy': {
    ...
    city: 'Bhubaneswar',
    line: 'BBSR Line',
    gstin: '21AABCA1234A1Z9',
    address: 'Plot No. 45, Saheed Nagar, Bhubaneswar - 751007',
    drugLicense: 'DL-21-9999',
    phone: '7890123456'
  },
  'City Pharma': {
    name: 'City Pharma',
...
export const INVOICES = [
  {
    ...
    status: 'UNPAID', overdueDays: 0, billType: 'Credit', discount: 250, creditBalance: 0,
    products: [
      { name: 'Pantoprazole 40mg', sku: 'PAN-40-TAB', company: 'Alkem', batch: 'PAN-07/26', packing: "10'S Tab", mrp: 48, rate: 34.50, chargeableQty: 120, freeQty: 6, hsn: '300490', gstRate: 12, expiryDate: 'Sep 2026', discountPercent: 0 },
      { name: 'Atorvastatin 10mg', sku: 'ATV-10-STR', company: 'Torrent', batch: 'ATV-F09/26', packing: "10'S Strip", mrp: 55, rate: 42.00, chargeableQty: 80, freeQty: 4, hsn: '300490', gstRate: 12, expiryDate: 'Feb 2027', discountPercent: 0 },
      { name: 'Amlodipine 5mg',    sku: 'AML-5-STR',  company: 'Cipla', batch: 'AML-B12/26', packing: "10'S Strip", mrp: 25, rate: 18.00, chargeableQty: 60, freeQty: 0, hsn: '300490', gstRate: 5,  expiryDate: 'Nov 2026', discountPercent: 0 },
    ],
  },
  {
    ...
    status: 'PAID', overdueDays: 0, billType: 'Cash', discount: 0, creditBalance: 0,
    products: [
      { name: 'Paracetamol 500mg', sku: 'PCM-500-STR', company: 'Cipla', batch: 'PCM-A12/26', packing: "10'S Strip", mrp: 18.5, rate: 13.20, chargeableQty: 200, freeQty: 20, hsn: '300490', gstRate: 5, expiryDate: 'Aug 2026', discountPercent: 5 },
      { name: 'Cetirizine 10mg',   sku: 'CTZ-10-STR',   company: 'Mankind', batch: 'CTZ-D04/26', packing: "10'S Strip", mrp: 28, rate: 19.50, chargeableQty: 100, freeQty: 0,  hsn: '300490', gstRate: 5, expiryDate: 'Jun 2026', discountPercent: 0 },
    ],
  },
  {
    ...
    status: 'PARTIALLY_PAID', overdueDays: 0, billType: 'Credit', discount: 500, creditBalance: 0,
    products: [
      { name: 'Metformin 500mg',   sku: 'MET-500-STR', company: 'USV', batch: 'MET-E15/25', packing: "10'S Strip", mrp: 32, rate: 24.50, chargeableQty: 200, freeQty: 20, hsn: '300490', gstRate: 5, expiryDate: 'Aug 2025', discountPercent: 10 },
      { name: 'Amoxicillin 250mg', sku: 'AMX-250-CAP', company: 'Sun Pharma', batch: 'AMX-C21/26', packing: '10 Caps',    mrp: 85, rate: 62.00, chargeableQty: 100, freeQty: 10, hsn: '300410', gstRate: 12, expiryDate: 'Mar 2026', discountPercent: 0 },
    ],
  },
  {
    ...
    status: 'PAID', overdueDays: 0, billType: 'Cash', discount: 100, creditBalance: 0,
    products: [
      { name: 'Omeprazole 20mg', sku: 'OME-20-CAP', company: "Dr. Reddy's", batch: 'OMZ-X03/26', packing: "10'S Cap", mrp: 38, rate: 28.00, chargeableQty: 150, freeQty: 0, hsn: '300490', gstRate: 12, expiryDate: 'Mar 2026', discountPercent: 0 },
    ],
  },
  {
    ...
    status: 'UNPAID', overdueDays: 0, billType: 'Credit', discount: 0, creditBalance: 0,
    products: [
      { name: 'Atorvastatin 10mg', sku: 'ATV-10-STR', company: 'Torrent', batch: 'ATV-F09/26', packing: "10'S Strip", mrp: 55, rate: 42.00, chargeableQty: 80, freeQty: 8, hsn: '300490', gstRate: 12, expiryDate: 'Feb 2027', discountPercent: 0 },
    ],
  },
  {
    ...
    status: 'UNPAID', overdueDays: 5, billType: 'Credit', discount: 200, creditBalance: 0,
    products: [
      { name: 'Metformin 500mg', sku: 'MET-500-STR', company: 'USV', batch: 'MET-E15/25', packing: "10'S Strip", mrp: 32, rate: 24.50, chargeableQty: 200, freeQty: 0, hsn: '300490', gstRate: 5, expiryDate: 'Aug 2025', discountPercent: 0 },
    ],
  },
  {
    ...
    status: 'UNPAID', overdueDays: 22, billType: 'Credit', discount: 0, creditBalance: 0,
    products: [],
  },
  {
    ...
    status: 'UNPAID', overdueDays: 44, billType: 'Credit', discount: 0, creditBalance: 0,
    products: [],
  },
  {
    ...
    status: 'PARTIALLY_PAID', overdueDays: 49, billType: 'Credit', discount: 300, creditBalance: 0,
    products: [],
  },
  // ✅ New: Prepaid credit scenario (no previous balance, credit > invoice due)
  {
    id: 'MIL-06-2025-044', client: 'Apollo Pharmacy', area: 'Bhubaneswar', line: 'BBSR Line',
    items: 2, amount: 5000, due: 5000, date: '2025-06-11', dueDate: '2025-06-25',
    status: 'UNPAID', overdueDays: 0, billType: 'Credit', discount: 0, creditBalance: 8000,
    products: [
      { name: 'Vitamin D3 60K', sku: 'VIT-06/28', company: 'USV', batch: 'VIT-06/28', packing: '4 Cap', mrp: 125, rate: 85.00, chargeableQty: 20, freeQty: 0, hsn: '300450', gstRate: 12, expiryDate: 'Jun 2028', discountPercent: 0 },
    ],
  },
];
