...
//   return (
//     <button onClick={() => onOpen(inquiry)} className="w-full text-left bg-white rounded-2xl border border-slate-200 p-4 md:hidden hover:shadow-sm transition-all active:scale-[0.98]">
