  ...
  return (
    <div className="bg-white rounded-2xl sm:rounded-3xl shadow-sm border border-slate-200 px-4 sm:px-5 py-3 sm:py-4">
      ...
      <div className="flex items-center justify-between mb-2 sm:mb-3">
        ...
        <span className={`text-[10px] sm:text-xs font-black px-2 sm:px-2.5 py-0.5 sm:py-1 rounded-lg 
      ...
      <div className="flex items-end justify-between mt-1">
        ...
        <div className="text-right flex flex-col items-end">
          <p className="text-slate-400 text-[8px] sm:text-[10px] font-bold uppercase tracking-wider mb-0.5">
            Vital Score
          </p>
          <p className="text-lg sm:text-xl font-black leading-none" style={{ color: getScoreColor(creditScore) }}>
            {creditScore}
          </p>
        </div>
      </div>
      ...
      {usedPercent > 100 && (
        <div className="mt-2 sm:mt-3 bg-red-50 p-1.5 sm:p-2 rounded-lg flex items-center gap-2">
          <AlertTriangle size={12} className="sm:text-red-500" />
          <p className="text-[9px] sm:text-[10px] text-red-700 font-bold">
